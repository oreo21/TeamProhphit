...
def student_home():
    ...
    print depts
    return render_template('student_home.html', numAps = num, aps=aps, selectedCourses=selectedCourses, student = student, depts=depts, myAvg = db_manager.get_department_averages(osis))
